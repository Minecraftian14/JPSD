...
public class DataWriter implements AutoCloseable, Closeable {
    ...
    public void writeEntry(ByteEntry b) throws IOException {
        writeByte(b.getValue());
    }

    public int writeEntry(BytesEntry bytes) throws IOException {
        return writeBytes(bytes.getValue());
    }

    public void writeEntry(ShortEntry b) throws IOException {
        stream.writeShort(b.getValue());
    }
