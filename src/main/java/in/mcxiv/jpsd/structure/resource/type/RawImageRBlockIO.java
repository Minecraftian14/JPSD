...
public class RawImageRBlockIO extends ImageResourceBlockIO<RawImageRBlock> {
    ...
    public RawImageRBlock read(DataReader reader, ImageResourceID id, String pascalString, long blockLength) throws IOException {
        ...
        PSDConnection.out.println("This block:RawImageRBlock needs a good test!");
        PSDConnection.out.println("We have the data stored as a dingle dimensional byte array. But the dimensions? The Color Mode? And similar details? We have nothing else...");
